public class AccountBank {
	    ...
	    public AccountBank(String soTaiKhoan) {
	    ...
	    public AccountBank(String soTaiKhoan, String tenChuTaiKhoan) {
	        this.soTaiKhoan = soTaiKhoan;
	    ...
	    public AccountBank(String soTaiKhoan, String tenChuTaiKhoan, double soDu) {
	        this.soTaiKhoan = soTaiKhoan;
	        this.tenChuTaiKhoan = tenChuTaiKhoan;
